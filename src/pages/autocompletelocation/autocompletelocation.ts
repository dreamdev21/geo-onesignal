...
@Component({
  selector: "page-autocompletelocation",
  templateUrl: "autocompletelocation.html"
})
export class AutocompletelocationPage {
  ...
  setLocation() {
    ...
    console.log(data);
    // var modalPage = this.modalCtrl.create(SetlocationPage, { data : data});
    // modalPage.present();

    let modalPage = this.modalCtrl.create(SetlocationPage, { data: data });
  ...
  viewCircle() {
    ...
    var cityCircle = new google.maps.Circle({
      ...
      fillOpacity: 0.35,
      center: amsterdam,
      radius: this.location.miles*1609
    });
